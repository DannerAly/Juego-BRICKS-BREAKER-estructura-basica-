...
// End Cross Module References
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_APaddle_NotifyHit_Statics::NewProp_NormalImpulse = { "NormalImpulse", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Paddle_eventNotifyHit_Parms, NormalImpulse), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_APaddle_NotifyHit_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_APaddle_NotifyHit_Statics::NewProp_NormalImpulse,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_APaddle_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_APaddle_NotifyHit, "NotifyHit" }, // 2121542872
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(APaddle, 1887899980);
